...
| [RFC 6797](https://www.rfc-editor.org/rfc/rfc6797)              | `site-architecture.md` §14                 | Belongs with the `_headers` emitter (`gap:emit-cache-headers`); HSTS is a deliberate opt-in because a wrong `max-age` locks an apex domain to HTTPS.               |
| [Referrer Policy](https://www.w3.org/TR/referrer-policy/)       | `site-architecture.md` §14                 | Same emitter.                                                                                                                                                      |
| [Permissions Policy](https://www.w3.org/TR/permissions-policy/) | `site-architecture.md` §14                 | Same emitter.                                                                                                                                                      |
...
_Jx Standards Alignment Specification v0.1.2-draft_
