...
The builder is a section of your project's configuration document. Pick **Open Project Settings › Content Types** from the ⚙ **Settings** menu at the foot of the rail — or press :kbd[⌘K] and run **Open Project Settings**, or use the **⬢ menu** in the Command Bar, then choose **Content Types** from the section list: your types are listed on the left, and selecting one opens its editor on the right. Like every other section of that document, what you do here is recorded as a step you can take back with :kbd[⌘Z]; see **[Project settings](/docs/studio/projects/settings)**.
