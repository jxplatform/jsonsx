...
| **Board**    | One column per category, each with a count — the shape of the project at a glance            |
...
**New** creates a Page, a Layout or a Component — each row names the folder the file lands in — and lists one row per content type your project defines.
