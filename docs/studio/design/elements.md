...
It opens in the Navigator, under an **INSERT · document** header. Unlike the other document panels it is happy with no document open — an element palette still means something before you have chosen where to put anything.
...
The new element arrives selected, ready for the Inspector's [Content](/docs/studio/design/properties) and [Style](/docs/studio/design/style-inspector) tabs. Dragging works the same in Edit and Design view; the other ways to insert — the **+** affordance between elements and the slash menu — are covered in **[The canvas](/docs/studio/interface/canvas)**.
