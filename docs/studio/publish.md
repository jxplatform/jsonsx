---
title: "Publish"
description: "How a Jx site goes live: Studio commits and pushes your files, then your host builds the static site and serves it from a CDN."
code:
...
The **deployment adapter** you picked when [creating the project](/docs/studio/projects/create) — Static, Cloudflare Pages, Node, or Bun — tells the build how to package the output for your target. Switching hosts means switching the adapter; your pages, components, and content stay the same.
