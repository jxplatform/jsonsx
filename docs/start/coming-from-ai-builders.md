...
- **[The AI assistant](/docs/studio/ai)** covers what it can do and how to work with it.
- **[Your first project](/docs/start/first-project)** shows the editor the assistant shares with you.
- **[Framework](/docs/framework)** documents the format underneath it all.
