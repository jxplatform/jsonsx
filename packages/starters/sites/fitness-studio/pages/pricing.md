...
:::div{style.maxWidth="var(--max-width)" style.margin="1.25rem auto 0" style.textAlign="center" style.color="var(--color-text-muted)" style.fontSize="0.9rem"}
Students and seniors save 15% on any plan — just ask at the front desk.
:::
:::::
...
::fs-feature{props.icon="❄️" props.title="Can I freeze my membership?" props.text="Yes — monthly and annual members can freeze for up to 8 weeks a year, no questions asked."}

::fs-feature{props.icon="📅" props.title="How do I book a class?" props.text="Reserve any class from the contact page or our app. Spots open 7 days ahead and fill quickly."}

::fs-feature{props.icon="↩️" props.title="What's your cancellation policy?" props.text="Cancel up to 4 hours before class for a full credit. Life happens — we keep it flexible."}
::::
:::::
